"""Premortem thinking technique — prompt generator."""
...
_SYSTEM_PROMPT = LENS_CATALOG["premortem"]


def build_prompt(artifact: Artifact, context: str) -> TechniquePrompt:
    """Build a premortem prompt for the host agent to apply."""
    user_prompt = f"""
...
"""
    return TechniquePrompt(
        ...
        diversity_hint=(
            ...
            "Premortem analysis benefits from an independent failure-mode "
            "exploration that isn't biased by other techniques' conclusions."
        ),
