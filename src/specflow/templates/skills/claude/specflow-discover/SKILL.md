...
- Read `references/level-boundaries.md` if unsure about REQ vs ARCH vs DDD boundaries.
- Read `references/normative-language.md` for proper requirement phrasing.
