...
| Data quality assurance | `autonomous-loop-protocol.md` (Phase 0.6 EDA, Phase 0.5 pre-check), `noise-handling-protocol.md` (validity gate) | Phase 0.6 runs once; Phase 0.5 runs per-iteration; noise validity gate runs per-EXPT |
