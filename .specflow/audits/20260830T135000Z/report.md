...
- **Timestamp**: 20260830T135000Z
- **Artifacts analyzed**: 726 (cached: 0)
- **Chain coverage**: 99% (113/114 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-114**: errors 0→0 (Δ0), warns 29→31 (Δ+2) (escalating 0→1, accounting 29→30), info 47→46 (Δ−1), chain coverage 100%→99% (Δ−1 pp)
...
### orphan-code
- [⚠] 3/248 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).

### verification
- [⚠] 2 test-verification coverage gap(s):   ⚠ [STORY-648] no UT linked via 'verified_by' (covers REQ REQ-038);   ⚠ [STORY-648] no IT linked via 'verified_by' (covers REQ REQ-038)
