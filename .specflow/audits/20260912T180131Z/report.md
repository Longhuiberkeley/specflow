...
- **Timestamp**: 20260912T180131Z
- **Artifacts analyzed**: 758 (cached: 0)
- **Chain coverage**: 95% (115/121 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-124**: errors 0→0 (Δ0), warns 41→44 (Δ+3) (escalating 5→6, accounting 36→38), info 49→49 (Δ0), chain coverage 95%→95% (Δ0 pp)
...
- [⚠] STORY-643 (implements REQ-001): no test verification
- [⚠] STORY-644 (implements REQ-001): no test verification
- [⚠] STORY-645 (implements REQ-001): no test verification
- [⚠] STORY-642 (implements REQ-003): no test verification
- [⚠] REQ-039: no ARCH refinement in V-model thread
- [⚠] STORY-650 (implements REQ-039): no test verification
- [⚠] STORY-651 (implements REQ-039): no test verification
- [⚠] STORY-652 (implements REQ-039): no test verification
- [⚠] REQ-040: no ARCH refinement in V-model thread
- [⚠] STORY-653 (implements REQ-040): no test verification
- [⚠] STORY-654 (implements REQ-040): no test verification
- [⚠] REQ-041: no ARCH refinement in V-model thread
- [⚠] STORY-655 (implements REQ-041): no test verification
- [⚠] REQ-042: no ARCH refinement in V-model thread
- [⚠] STORY-656 (implements REQ-042): no test verification
- [⚠] STORY-657 (implements REQ-042): no test verification
...
- [○] Project: 4 aspirational AC(s) across 3 REQ(s); 40/43 REQ(s) aspirational-free (89 observable, 168 unclassified)

### completeness
- [⚠] 4 structural coverage gap(s):   ⚠ [REQ-039] no ARCH derives_from this approved requirement;   ⚠ [REQ-040] no ARCH derives_from this approved requirement;   ⚠ [REQ-041] no ARCH derives_from this approved requirement;   ⚠ [REQ-042] 

### docs-staleness
- [○] 15 doc(s) scanned; all citations current.

### nfr-coverage
- [○] 5/44 REQs have no non_functional_category
- [○] NFR categories: functional(39)

### orphan-code
- [⚠] 1/251 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).

### verification
- [⚠] 18 test-verification coverage gap(s):   ⚠ [STORY-650] no UT linked via 'verified_by' (covers REQ REQ-039);   ⚠ [STORY-650] no IT linked via 'verified_by' (covers REQ REQ-039);   ⚠ [STORY-650] no QT linked via 'verified_by' (covers REQ REQ
- [○] 88 artifact(s) declare verify_command; all have current, green verify runs.

## AC observability detail

Per-AC rows for the ac-observability cross-cutting lens: 172 of 261 AC item(s) across 43 REQ(s) with ACs are classified unclassified or aspirational. Observable items are omitted here (they need no action); the full all-class per-AC table is in this audit snapshot's subagent-cross-cutting.md.
