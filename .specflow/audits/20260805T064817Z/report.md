...
- **Timestamp**: 20260805T064817Z
- **Artifacts analyzed**: 623 (cached: 0)
- **Chain coverage**: 100% (101/101 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-081**: errors 0→0 (Δ0), warns 0→25 (Δ+25) (escalating 0→0, accounting 0→25), info 82→57 (Δ−25), chain coverage 100%→100% (Δ0 pp)
...
### baseline-drift
- [○] CHL-339: status open → addressed
- [○] CHL-341: status open → addressed
- [○] CHL-345: status open → stale
- [○] CHL-346: status open → stale
- [○] CHL-NONSEMVE-c16b: status open → addressed
- [○] CHL-RELEASEB-58c6: status open → addressed
- [○] CHL-RELEASEE-b5ca: status open → addressed
- [○] CHL-344: content changed (fingerprint drift)
- [○] QT-014: content changed (fingerprint drift)
- [○] QT-036: content changed (fingerprint drift)
- [○] QT-037: content changed (fingerprint drift)
