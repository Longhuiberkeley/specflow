...
- **Timestamp**: 20260830T085708Z
- **Artifacts analyzed**: 708 (cached: 0)
- **Chain coverage**: 99% (111/112 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-108**: errors 0→0 (Δ0), warns 29→33 (Δ+4) (escalating 0→2, accounting 29→31), info 45→47 (Δ+2), chain coverage 100%→99% (Δ−1 pp)
...
- [⚠] REQ-038: no ARCH refinement in V-model thread
- [⚠] STORY-646 (implements REQ-038): no test verification
...
- [○] Project: 3 aspirational AC(s) across 2 REQ(s); 38/40 REQ(s) aspirational-free (86 observable, 158 unclassified)

### completeness
- [⚠] 1 structural coverage gap(s):   ⚠ [REQ-038] no ARCH derives_from this approved requirement

### docs-staleness
- [○] 15 doc(s) scanned; all citations current.

### nfr-coverage
- [○] 1/40 REQs have no non_functional_category
- [○] NFR categories: functional(39)

### orphan-code
- [○] All 245 source files traced to a STORY/REQ.

### verification
- [⚠] 3 test-verification coverage gap(s):   ⚠ [STORY-646] no UT linked via 'verified_by' (covers REQ REQ-038);   ⚠ [STORY-646] no IT linked via 'verified_by' (covers REQ REQ-038);   ⚠ [STORY-646] no QT linked via 'verified_by' (covers REQ REQ
- [○] 88 artifact(s) declare verify_command; all have current, green verify runs.

## AC observability detail

Per-AC rows for the ac-observability cross-cutting lens: 161 of 247 AC item(s) across 40 REQ(s) with ACs are classified unclassified or aspirational. Observable items are omitted here (they need no action); the full all-class per-AC table is in this audit snapshot's subagent-cross-cutting.md.
