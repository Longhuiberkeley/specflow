...
- **Timestamp**: 20260911T133653Z
- **Artifacts analyzed**: 752 (cached: 0)
- **Chain coverage**: 95% (115/121 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-122**: errors 0→0 (Δ0), warns 29→41 (Δ+12) (escalating 0→5, accounting 29→36), info 50→49 (Δ−1), chain coverage 100%→95% (Δ−5 pp)
...
### completeness
- [⚠] 3 structural coverage gap(s):   ⚠ [REQ-039] no ARCH derives_from this approved requirement;   ⚠ [REQ-040] no ARCH derives_from this approved requirement;   ⚠ [REQ-041] no ARCH derives_from this approved requirement

### docs-staleness
- [○] 15 doc(s) scanned; all citations current.

### nfr-coverage
- [○] 4/43 REQs have no non_functional_category
