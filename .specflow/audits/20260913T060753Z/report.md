...
- **Timestamp**: 20260913T060753Z
- **Artifacts analyzed**: 783 (cached: 0)
- **Chain coverage**: 100% (130/130 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-125**: errors 0→0 (Δ0), warns 44→34 (Δ−10) (escalating 6→5, accounting 38→29), info 49→49 (Δ0), chain coverage 95%→100% (Δ+5 pp)
...
- [⚠] REQ-039: ARCH exists but no DDD refinement
- [⚠] REQ-040: ARCH exists but no DDD refinement
- [⚠] REQ-041: ARCH exists but no DDD refinement
- [⚠] REQ-042: ARCH exists but no DDD refinement
...
### orphan-code
- [⚠] 2/252 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).
...
Per-AC rows for the ac-observability cross-cutting lens: 169 of 262 AC item(s) across 44 REQ(s) with ACs are classified unclassified or aspirational. Observable items are omitted here (they need no action); the full all-class per-AC table is in this audit snapshot's subagent-cross-cutting.md.
