...
- **Timestamp**: 20260804T205902Z
- **Artifacts analyzed**: 607 (cached: 0)
- **Chain coverage**: 100% (100/100 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-PROJECTA-f7ce**: n/a (prior audit predates summary stamping)
...
- [○] REQ-035: 4 linked test(s) < 17 AC item(s) (4 green) — review coverage
...
### orphan-code
- [⚠] 1/223 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).

### verification
- [○] 58 artifact(s) declare verify_command; all have current, green verify runs.
