...
- **Timestamp**: 20260818T104824Z
- **Artifacts analyzed**: 658 (cached: 0)
- **Chain coverage**: 99% (101/102 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-097**: errors 0→0 (Δ0), warns 25→29 (Δ+4) (escalating 0→1, accounting 25→28), info 45→44 (Δ−1), chain coverage 100%→99% (Δ−1 pp)
...
- [⚠] STORY-632 (implements REQ-001): no test verification
- [⚠] STORY-632 (implements REQ-005): no test verification
...
### orphan-code
- [⚠] 1/238 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).

### verification
- [⚠] 6 test-verification coverage gap(s):   ⚠ [STORY-632] no UT linked via 'verified_by' (covers REQ REQ-001);   ⚠ [STORY-632] no IT linked via 'verified_by' (covers REQ REQ-001);   ⚠ [STORY-632] no QT linked via 'verified_by' (covers REQ REQ
