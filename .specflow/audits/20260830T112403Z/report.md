...
- **Timestamp**: 20260830T112403Z
- **Artifacts analyzed**: 711 (cached: 0)
- **Chain coverage**: 99% (111/112 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-109**: errors 0→0 (Δ0), warns 33→32 (Δ−1) (escalating 2→2, accounting 31→30), info 47→47 (Δ0), chain coverage 99%→99% (Δ0 pp)
...
- [○] Project: 3 aspirational AC(s) across 2 REQ(s); 38/40 REQ(s) aspirational-free (88 observable, 158 unclassified)
...
### verification
- [⚠] 2 test-verification coverage gap(s):   ⚠ [STORY-646] no UT linked via 'verified_by' (covers REQ REQ-038);   ⚠ [STORY-646] no IT linked via 'verified_by' (covers REQ REQ-038)
- [○] 88 artifact(s) declare verify_command; all have current, green verify runs.

## AC observability detail

Per-AC rows for the ac-observability cross-cutting lens: 161 of 249 AC item(s) across 40 REQ(s) with ACs are classified unclassified or aspirational. Observable items are omitted here (they need no action); the full all-class per-AC table is in this audit snapshot's subagent-cross-cutting.md.
