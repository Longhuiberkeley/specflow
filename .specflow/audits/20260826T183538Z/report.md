...
- **Timestamp**: 20260826T183538Z
- **Artifacts analyzed**: 701 (cached: 0)
- **Chain coverage**: 97% (108/111 approved STORYs fully covered by UT+IT+QT)
- **Trend vs AUD-106**: errors 0→0 (Δ0), warns 29→31 (Δ+2) (escalating 0→1, accounting 29→30), info 45→44 (Δ−1), chain coverage 99%→97% (Δ−2 pp)
...
### orphan-code
- [⚠] 4/244 source files orphaned (not traced to any STORY/REQ). Run `specflow detect orphan-code` (adopt with --retro-link).

### verification
- [⚠] 3 test-verification coverage gap(s):   ⚠ [STORY-640] no IT linked via 'verified_by' (covers REQ REQ-001);   ⚠ [STORY-639] no IT linked via 'verified_by' (covers REQ REQ-003);   ⚠ [STORY-641] no IT linked via 'verified_by' (covers REQ REQ
