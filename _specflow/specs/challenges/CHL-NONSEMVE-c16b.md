...
Closed with v1.13.5 (2026-08-05), the release that ships STORY-630. Policy chosen: comprehensive (a)+(b) — enforce semver names at create time AND prefer semver releases at selection, per user decision; freeform baselines remain legal on disk (grandfathered) but second-class for selection.
